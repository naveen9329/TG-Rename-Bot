...
"""
    ...
    UPGRADE_TEXT = "There is no plane till now you are free to use me 🤩"
...
URL | filename | username | password"""
    ...
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size more than 1.95 GB \nSorry 😔. But, I cannot upload files greater than 1.95GB due to Telegram API limitations 😡./nPlease use @anonymousleechgroup for making splitted files which is created by my boss"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Please rate me if you find me useful. Join : @anonymousbotsupporte"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in 📥 {} seconds.\nUploaded in 📤 {} seconds.\n<b>Please Join 🥺: @anonymousbotsupporte </b>"
